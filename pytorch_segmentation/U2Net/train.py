...
from src.u2net import u2net_full, u2net_lite
...
def main(args):
    ...
    train_dataset = DUTSDataset(args.data_path, txt_name="DUTS-TR",
                                transforms=SODPresetTrain([320, 320], crop_size=288))
    val_dataset = DUTSDataset(args.data_path, txt_name="DUTS-TE",
...
def parse_args():
    ...
    parser.add_argument("--data-path", default=r"D:\Code_python\deeplearn_data\DUTS", help="DUTS root")
